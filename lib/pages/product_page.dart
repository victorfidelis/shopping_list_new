...
class _ProductPageState extends State<ProductPage>
  ...
  Future<void> refreshListProducts([bool showLoading = false]) async {
    ...
    try {
      ...
      setState(() {
        ...
        loadingError = false;
        listProduct =
            firebaseProducts.docs.map((e) => Product.fromDocument(e)).toList();
        listProduct.sort(
  ...
  void delete(Product productDelete, int index) {
    ...
    AlertDialog alertFail = AlertDialog(
      title: const Text('Produto em lista'),
      content: Text(
          'O produto "${productDelete.name}" não pode ser excluído pois consta em lista.'),
      actions: [
    ...
    consultProductInList(productDelete.id!).then((value) {
      if (value){
        setState(() {
          loading = false;
        });
